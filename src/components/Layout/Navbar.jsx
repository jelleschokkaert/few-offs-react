...
const Navbar = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentPromoIndex((prev) => (prev + 1) % PROMO_TEXTS.length);
    }, 4000);
  ...
  const handleMouseEnter = useCallback((menu) => setActiveMenu(menu), []);
          ...
          <div className="container main-nav-inner">
            ...
            <nav className="desktop-nav">
              ...
              >
                ...
                <MegaMenu data={navData.men} isVisible={activeMenu === "men"} />
              </div>
              <div
                className="nav-item"
